			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="rolePosition" title="${message(code: 'role.rolePosition.label', default: 'Role Position')}" />
				...
				<g:each in="${roleInstanceList}" status="i" var="roleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: roleInstance, field: "rolePosition")}</td>
