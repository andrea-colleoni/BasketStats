	...
	<body>
		...
		<div id="show-role" class="content scaffold-show" role="main">
			...
			<ol class="property-list role">
				...
				<g:if test="${roleInstance?.rolePosition}">
				<li class="fieldcontain">
					<span id="rolePosition-label" class="property-label"><g:message code="role.rolePosition.label" default="Role Position" /></span>
					
						<span class="property-value" aria-labelledby="rolePosition-label"><g:fieldValue bean="${roleInstance}" field="rolePosition"/></span>
